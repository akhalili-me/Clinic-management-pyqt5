...
class Patients:
    ...
    def add_patient(db:DatabaseManager, patient):
        query = "INSERT INTO Patient(firstName, lastName, gender, age, phoneNumber, address, identityCode, extraInfo) VALUES (?,?,?,?,?,?,?,?)"
        values = (patient["firstName"], patient["lastName"], patient["gender"], patient["age"], patient["phoneNumber"], patient["address"], patient["identityCode"], patient["extraInfo"])
        try:
