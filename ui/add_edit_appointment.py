...
"")
        ...
        self.service_cmbox.addItem("")
        self.label_4 = QtWidgets.QLabel(addEditAppointment_form)
        self.label_4.setGeometry(QtCore.QRect(110, 20, 191, 41))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, addEditAppointment_form):
        ...
        self.label_4.setText(_translate("addEditAppointment_form", "اضافه کردن نوبت"))
