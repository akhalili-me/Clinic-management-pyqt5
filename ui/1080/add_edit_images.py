...
class Ui_aeImage(object):
    def setupUi(self, addEditImage_form):
        addEditImage_form.setObjectName("addEditImage_form")
        addEditImage_form.resize(424, 190)
        addEditImage_form.setMinimumSize(QtCore.QSize(424, 190))
        addEditImage_form.setMaximumSize(QtCore.QSize(424, 190))
        self.save_btn = QtWidgets.QPushButton(addEditImage_form)
        self.save_btn.setGeometry(QtCore.QRect(170, 150, 91, 31))
        font = QtGui.QFont()
...
"")
        ...
        self.cancel_btn.setGeometry(QtCore.QRect(270, 150, 75, 31))
        font = QtGui.QFont()
        font.setFamily("Vazirmatn")
        font.setPointSize(12)
        font.setBold(True)
...
"")
        ...
        self.imageName_txtbox.setGeometry(QtCore.QRect(10, 10, 331, 31))
...
"")
        ...
        self.label_5.setGeometry(QtCore.QRect(330, 20, 71, 20))
        font = QtGui.QFont()
        ...
        self.chooseImage_btn.setGeometry(QtCore.QRect(220, 100, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Vazirmatn")
        font.setPointSize(10)
        font.setBold(True)
...
"")
        ...
        self.label_6.setGeometry(QtCore.QRect(340, 60, 71, 21))
        font = QtGui.QFont()
        font.setFamily("Vazirmatn Black")
        font.setPointSize(10)
        ...
        self.imagePath_txtbox.setGeometry(QtCore.QRect(10, 50, 331, 31))
