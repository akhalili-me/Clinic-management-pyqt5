...
# Form implementation generated from reading ui file 'medical_records.ui'
#
...
"")
    ...
    def retranslateUi(self, medicalRecordsInfo_form):
        _translate = QtCore.QCoreApplication.translate
        medicalRecordsInfo_form.setWindowTitle(_translate("medicalRecordsInfo_form", "پرونده بیمار"))
        self.addNewMedicalRecord_btn.setText(_translate("medicalRecordsInfo_form", "افزودن خدمات جدید به پرونده"))
        ...
        self.label_39.setText(_translate("medicalRecordsInfo_form", "اطلاعات بیمار"))
        self.firstName_lbl.setText(_translate("medicalRecordsInfo_form", "امیررضا "))
        self.label_35.setText(_translate("medicalRecordsInfo_form", "نام:"))
        self.lastName_lbl.setText(_translate("medicalRecordsInfo_form", "خلیلی"))
        self.label_38.setText(_translate("medicalRecordsInfo_form", "نام خانوادگی:"))
        self.gender_lbl.setText(_translate("medicalRecordsInfo_form", "مرد"))
        self.label_41.setText(_translate("medicalRecordsInfo_form", "جنسیت:"))
        self.age_lbl.setText(_translate("medicalRecordsInfo_form", "۲۳"))
        self.label_43.setText(_translate("medicalRecordsInfo_form", "سن: "))
        self.identityCode_lbl.setText(_translate("medicalRecordsInfo_form", "۱۸۳۰۶۸۲۰۰۸"))
        self.label_45.setText(_translate("medicalRecordsInfo_form", "کد ملی:"))
        self.phoneNumber_lbl.setText(_translate("medicalRecordsInfo_form", "۰۹۰۱۲۷۲۳۵۸۹۹"))
        self.label_47.setText(_translate("medicalRecordsInfo_form", "شماره تلفن:"))
        self.extraInfo_lbl.setText(_translate("medicalRecordsInfo_form", "مبتلا به تنگی نفس"))
        self.a.setText(_translate("medicalRecordsInfo_form", "اطلاعات اضافه:"))
        self.address_lbl.setText(_translate("medicalRecordsInfo_form", "اهواز باغملک خیابان ۳ رشت"))
